...
\small{{\bf{ABSTRACT}}}
 ...
 {\bf{Methods}}: C2C12 myotubes were exposed for 48 hours to plasma collected 6 days before (BDC-6) and 6 days after a head-down tilt bed rest protocol (HDT6). Myotube diameter and expression of myosin heavy chain isoforms were analysed, together with proteins involved in protein synthesis (p-Akt, p-4EBP1, p-p70S6K), protein degradation (ubiquitinated proteins), cellular stress (p-p38, p-AMPK), and mitochondrial biogenesis (PGC1-$\alpha$).
